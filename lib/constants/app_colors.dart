...
class AppColors {
  static const Color primary     = Color(0xFF062C2B);
  static const Color secondary   = Color(0xFF0F766E);
  static const Color accent      = Color(0xFF14B8A6);
  static const Color background  = Color(0xFFF4F7F6);
  static const Color cardBg      = Colors.white;
  static const Color pending     = Color(0xFFFEF3C7);
  static const Color pendingText = Color(0xFFB45309);
  static const Color inProgress  = Color(0xFFE0F2FE);
  ...
  static const Color cancelled   = Color(0xFFFFE4E6);
